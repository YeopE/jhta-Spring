...
import com.example.demo.security.CustomOAth2UserDetailService;
...
public class SecurityConfig {
    ...
    @Autowired
    CustomOAth2UserDetailService customOAth2UserDetailService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        http.oauth2Login(httpSecurityOAuth2LoginConfigurer -> {
            ...
            httpSecurityOAuth2LoginConfigurer.loginProcessingUrl("/login/ouath2/code/naver"); //redirect_uri 설정한 값
            httpSecurityOAuth2LoginConfigurer.userInfoEndpoint(userInfoEndpointConfig -> {
               //OAuth2 로그인 성공후 사용자 정보를 가져와서 해야 할 일 작성
               userInfoEndpointConfig.userService(customOAth2UserDetailService);
            });
